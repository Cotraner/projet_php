...
<body class="body">
    <nav class="navbar navbar-dark bg-primary">
		...
		<a href="create_patient.php" <button class="buttonLog">Créer un compte patient</button></a>
    </nav>
    
    <form id="form_login" action="medic_creation.php" method="POST">
    <p class="type_conn">Creation Medecin</p>
    ...
    <div class="form-group">
        ...
        <input type="text" name="code_post" class="form-control" id="exampleInputPassword1" placeholder="code postal"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="specialite" class="form-control" id="exampleInputPassword1" placeholder="specialité"/>
    </div>
    <div id="register">
